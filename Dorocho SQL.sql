...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 03 avr. 2026 à 15:24
...
(1, 'phpmyadmin', 'root', 'DOROCHO', '-- ============================================================\r\n-- 1. TABLES INDÉPENDANTES ET ADMINISTRATION\r\n-- ============================================================\r\n\r\nCREATE TABLE Administrateur (\r\n    idAdmin INT PRIMARY KEY AUTO_INCREMENT,\r\n    nom VARCHAR(100),\r\n    login VARCHAR(50) UNIQUE NOT NULL,\r\n    motDePasse VARCHAR(255) NOT NULL\r\n);\r\n\r\nCREATE TABLE FAQ (\r\n    idFAQ INT PRIMARY KEY AUTO_INCREMENT,\r\n    question TEXT NOT NULL,\r\n    reponse TEXT NOT NULL\r\n);\r\n\r\nCREATE TABLE InformationLegale (\r\n    idInfo INT PRIMARY KEY AUTO_INCREMENT,\r\n    titre VARCHAR(255),\r\n    contenu TEXT,\r\n    dateMiseAJour DATETIME DEFAULT CURRENT_TIMESTAMP\r\n);\r\n\r\n-- ============================================================\r\n-- 2. SYSTÈME D\'UTILISATEURS (Héritage)\r\n-- ============================================================\r\n\r\nCREATE TABLE Utilisateur (\r\n    idUtilisateur INT PRIMARY KEY AUTO_INCREMENT,\r\n    nom VARCHAR(100),\r\n    prenom VARCHAR(100),\r\n    email VARCHAR(150) UNIQUE NOT NULL,\r\n    mdp VARCHAR(255) NOT NULL,\r\n    role VARCHAR(20) -- Ex: \'Etudiant\', \'Bailleur\'\r\n);\r\n\r\nCREATE TABLE Etudiant (\r\n    idUtilisateur INT PRIMARY KEY,\r\n    age INT,\r\n    localisation VARCHAR(255),\r\n    CONSTRAINT fk_etudiant_user FOREIGN KEY (idUtilisateur) REFERENCES Utilisateur(idUtilisateur) ON DELETE CASCADE\r\n);\r\n\r\nCREATE TABLE Bailleur (\r\n    idUtilisateur INT PRIMARY KEY,\r\n    estVerifie BOOLEAN DEFAULT FALSE,\r\n    estShadowban BOOLEAN DEFAULT FALSE,\r\n    CONSTRAINT fk_bailleur_user FOREIGN KEY (idUtilisateur) REFERENCES Utilisateur(idUtilisateur) ON DELETE CASCADE\r\n);\r\n\r\n-- ============================================================\r\n-- 3. ANNONCES ET MESSAGERIE\r\n-- ============================================================\r\n\r\nCREATE TABLE Annonce (\r\n    idAnnonce INT PRIMARY KEY AUTO_INCREMENT,\r\n    titre VARCHAR(255) NOT NULL,\r\n    description TEXT,\r\n    prix DECIMAL(10, 2),\r\n    localisation VARCHAR(255),\r\n    estColocation BOOLEAN DEFAULT FALSE,\r\n    datePublication DATETIME DEFAULT CURRENT_TIMESTAMP,\r\n    idBailleur INT NOT NULL,\r\n    CONSTRAINT fk_annonce_bailleur FOREIGN KEY (idBailleur) REFERENCES Bailleur(idUtilisateur) ON DELETE CASCADE\r\n);\r\n\r\nCREATE TABLE Message (\r\n    idMessage INT PRIMARY KEY AUTO_INCREMENT,\r\n    contenu TEXT NOT NULL,\r\n    dateEnvoi DATETIME DEFAULT CURRENT_TIMESTAMP, -- Inclut l\'heure pour l\'ordre des chats\r\n    estLu BOOLEAN DEFAULT FALSE,\r\n    idEtudiant INT NOT NULL,\r\n    idBailleur INT NOT NULL,\r\n    CONSTRAINT fk_msg_etudiant FOREIGN KEY (idEtudiant) REFERENCES Etudiant(idUtilisateur),\r\n    CONSTRAINT fk_msg_bailleur FOREIGN KEY (idBailleur) REFERENCES Bailleur(idUtilisateur)\r\n);\r\n\r\n-- ============================================================\r\n-- 4. INTERACTIONS ET CLASSES ASSOCIATIONS\r\n-- ============================================================\r\n\r\nCREATE TABLE Favoris (\r\n    idEtudiant INT,\r\n    idAnnonce INT,\r\n    dateAjout DATETIME DEFAULT CURRENT_TIMESTAMP,\r\n    PRIMARY KEY (idEtudiant, idAnnonce),\r\n    CONSTRAINT fk_fav_etudiant FOREIGN KEY (idEtudiant) REFERENCES Etudiant(idUtilisateur) ON DELETE CASCADE,\r\n    CONSTRAINT fk_fav_annonce FOREIGN KEY (idAnnonce) REFERENCES Annonce(idAnnonce) ON DELETE CASCADE\r\n);\r\n\r\nCREATE TABLE Signalement (\r\n    idSignalement INT PRIMARY KEY AUTO_INCREMENT,\r\n    motif TEXT NOT NULL,\r\n    dateSignalement DATETIME DEFAULT CURRENT_TIMESTAMP,\r\n    statut VARCHAR(50) DEFAULT \'En attente\',\r\n    idEtudiant INT NOT NULL,\r\n    idAnnonce INT NOT NULL,\r\n    CONSTRAINT fk_sign_etudiant FOREIGN KEY (idEtudiant) REFERENCES Etudiant(idUtilisateur),\r\n    CONSTRAINT fk_sign_annonce FOREIGN KEY (idAnnonce) REFERENCES Annonce(idAnnonce)\r\n);\r\n\r\nCREATE TABLE Candidature (\r\n    idCandidature INT PRIMARY KEY AUTO_INCREMENT,\r\n    message TEXT,\r\n    statut VARCHAR(50) DEFAULT \'Envoyée\',\r\n    dateEnvoi DATETIME DEFAULT CURRENT_TIMESTAMP,\r\n    idEtudiant INT NOT NULL,\r\n    idAnnonce INT NOT NULL,\r\n    CONSTRAINT fk_cand_etudiant FOREIGN KEY (idEtudiant) REFERENCES Etudiant(idUtilisateur),\r\n    CONSTRAINT fk_cand_annonce FOREIGN KEY (idAnnonce) REFERENCES Annonce(idAnnonce)\r\n);');
...
('root', '[{\"db\":\"phpmyadmin\",\"table\":\"administrateur\"}]');
...
('root', '2026-04-03 13:21:29', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
