...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
            Créez votre compte pour publier vos annonces de logement
        </p>
    </div>
        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <form class="space-y-6" action="<?php echo URLROOT; ?>/auth/registerHandler" method="POST">
                ...
                <div class="space-y-4 pt-4 border-t border-gray-200">
                    <div class="flex items-center">
                        ...
                        <label for="cgu" class="ml-2 block text-sm text-gray-900">
                            J'accepte les <a href="<?php echo URLROOT; ?>/page/cgu" class="text-green-600 hover:text-green-500">conditions générales d'utilisation</a> <span class="text-red-500">*</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="text-sm text-center">
                    <span class="text-gray-600">Pas bailleur ?</span>
                    <a href="<?php echo URLROOT; ?>/auth/register/etudiant" class="font-medium text-blue-600 hover:text-blue-500">
